...
function Services() {
  ...
  return (
    <div className="bg-purple-gradient min-h-screen relative flex flex-col items-center justify-center p-10">
      {/* Background Image */}
      <div
        className="absolute top-[0px] left-0 w-1/3 h-full bg-no-repeat bg-contain opacity-80 z-0"
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-20">
          <div className="bg-white p-8 rounded-lg shadow-lg text-center">
            <h3 className="text-2xl font-bold mb-4">Confirm Your Selection</h3>
            <p className="text-lg mb-6">
              You selected <span className="font-semibold">{selectedSize}</span> with a{' '}
              <span className="font-semibold">{selectedService}</span> service.
            </p>
